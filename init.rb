...
Rails.application.config.to_prepare do
  require_dependency File.expand_path('lib/redmine_ldap_passwd/account_controller_patch', __dir__)
  require_dependency File.expand_path('lib/redmine_ldap_passwd/my_controller_patch', __dir__)
  require_dependency File.expand_path('lib/redmine_ldap_passwd/auth_sources_helper_patch', __dir__)
end
